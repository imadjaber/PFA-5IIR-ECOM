    ...
    <div>
      ...
      {discount === 0 ? (
        <div className={styles.price}>
          <span className={styles.main}>DH;{markedPrice.toLocaleString()}</span>
        </div>
      ) : (
        <div className={styles.price}>
          <span className={styles.main}>DH{sellingPrice.toLocaleString()}</span>
          <span className={styles.original}>
            {" "}
            DH{markedPrice.toLocaleString()}
          </span>
